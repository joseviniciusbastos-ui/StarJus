      ...
      <div className="w-full lg:w-2/5 flex items-center justify-center p-12 bg-zinc-950">
        <div className="w-full max-w-sm space-y-12 animate-fade-in-up">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              className="w-full flex items-center justify-center gap-3 py-5 bg-gradient-to-r from-gold-600 to-gold-700 hover:from-gold-500 hover:to-gold-600 text-black rounded-2xl shadow-xl shadow-gold-900/10 font-black uppercase tracking-widest text-[10px] transition-all active:scale-[0.98]"
            >
              Acessar Painel
              <ArrowRight size={18} />
            </button>
