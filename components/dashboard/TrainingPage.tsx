    ...
    <div className="space-y-12 animate-in fade-in duration-700">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6">
        <div className="space-y-2">
          ...
          <p className="text-[10px] font-black text-zinc-500 uppercase tracking-[0.4em]">Desenvolvimento Profissional & Governança Alpha</p>
        </div>
        ...
        {MOCK_TRAINING.map((course) => (
          <div key={course.id} className="premium-card rounded-[3.5rem] border-zinc-900 shadow-2xl overflow-hidden flex flex-col group hover:shadow-gold-900/10 hover:-translate-y-2 transition-all duration-500">
            ...
            <div className="p-10 flex-1 flex flex-col bg-zinc-900/80 backdrop-blur-xl">
              <span className={`text-[9px] font-black uppercase tracking-[0.4em] mb-4 px-4 py-1.5 rounded-full inline-block w-fit border ${
                course.category === 'Jurisprudência' ? 'bg-blue-500/10 text-blue-400 border-blue-500/20' :
